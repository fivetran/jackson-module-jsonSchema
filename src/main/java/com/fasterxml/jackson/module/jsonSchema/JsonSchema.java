...
public abstract class JsonSchema
{
 ...
 //                 && equals(getType(), getType())
	...
	/**
	 * This function demands a DynamicSchema.
	 * DynamicSchema is annotated with @JsonDeserialize.
	 * Therefore, Jackson invokes DynamicSchemaDeserializer.
	 *
	 * The result is similar to what would happen if we annotated JsonSchema with @JsonDeserialize,
	 * except that @JsonCreator isn't inherited.
     */
	@JsonCreator
	public static JsonSchema create(DynamicSchema late) throws JsonProcessingException {
		return late.result;
	}
}
